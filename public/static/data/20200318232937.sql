...
CREATE TABLE `tb_logs` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COMMENT='操作日志表';
-- ----------------------------
-- Records of tb_logs
-- ----------------------------
...
INSERT INTO `tb_logs` (`id`,`username`,`action`,`ip_addr`,`details`,`create_time`) VALUES ('72','admin','编辑权限规则Manager/del','192.168.182.1','UPDATE `tb_auth_competency`  SET `name`='删除管理员',`url`='Manager/del',`remark`='拥有删除管理员的能力',`update_time`='2020-03-18 23:16:56'  WHERE  `id` = 13','2020-03-18 23:16:56');
